...
void startGame() {
  ...
  if (time_is_up) {
    ...
    // the color code read from serial comm. with Bluetooth
    String color_code = "";
...
void generateCombinations() {
  ...
  Serial.println(num_combinations);
  ...
  for (int i = 0; i < num_combinations; i++) {
    ...
    if (level == 1) {
      ...
      Serial.print("Color: ");
      Serial.println(combinations_level_1[i]);
      ...
      Serial.print("Color: ");
      Serial.println(combinations_level_2[i]);
      ...
      Serial.print("Color: ");
      Serial.println(combinations_level_3[i]);
